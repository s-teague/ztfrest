'''
Given a csv file of candidates needing ForcePhotZTF photometry:
trigger ForcePhotZTF (in old python environment) and write
results to database.
'''
...
if __name__ == '__main__':
    ...
    if len(t_for_phot) > 0:
        ...
        print("There are no candidates needing ForcePhotZTF.")
